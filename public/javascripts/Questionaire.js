...
let data =[
    ...
    {id:10,q:"Do you have two or more diagnoses of the following: depression, cancer, HIV/AIDS, diabetes, heart failure, " +
            ...
            " or any others diagnoses?",yes:12,no:17}, // This will connect to the Depression questionnaire
    ...
    {id:22,q:"Do you feel bad about yourself - or think that you are a failure or have let you or your family down?",yes:23,no:23},
    {id:23,q:"Do you have trouble concentrating on things such as watching television?",yes:24,no:24},
    {id:24,q:"Do you have so little or so much energy that other people would notice?",yes:25,no:25},
    {id:25,q:"Do you have thoughts that you would be better off dead or have thoughts of hurting yourself?",yes:26,no:26,ccm:12},
    ...
    {id:44,q:"Have you often been unable to remember what happened the night before because of drinking?",yes:45,no:45},
    ...
    {id:51,q:'Are you always able to stop using drugs when you want too? (If you never used drugs, answer "Yes")',yes:52,no:52},
    {id:52,q:'Have you had "blackouts" or "flashbacks" as a result of drug use?', yes:53,no:53},
    {id:53,q:'Do you ever feel bad or guilty about your drug use? (If you never used drugs, choose "No")',yes:54,no:54},
